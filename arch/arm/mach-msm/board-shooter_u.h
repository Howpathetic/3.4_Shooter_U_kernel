...
#define SHOOTER_U_GPIO_CAM_MCLK     	 (32)
#define SHOOTER_U_GPIO_CAM_VCM_PD      (58)
#define SHOOTER_U_GPIO_CAM1_RSTz       (137)
#define SHOOTER_U_GPIO_CAM2_RSTz       (138)
#define SHOOTER_U_GPIO_CAM2_PWDN       (140)
#define SHOOTER_U_GPIO_MCLK_SWITCH     (141)
...
void  init shooter_u_audio_init(void);
